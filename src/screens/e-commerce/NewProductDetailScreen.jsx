...
export default function NewProductDetailScreen() {
  ...
  var IMAGES = [
    product.result.IMAGE_1 ? product.result.IMAGE_1 : undefined,
    product.result.IMAGE_2 ? product.result.IMAGE_2 : undefined,
    product.result.IMAGE_3 ? product.result.IMAGE_3 : undefined,
  ]
            ...
            <View>
              <TouchableOpacity style={styles.category}>
                ...
                <Text style={styles.categoryName} numberOfLines={2}>
                  {product.result.categorie.NOM}
                </Text>
              </TouchableOpacity>
              <View style={styles.productNames}>
                <Text style={styles.productName}>
                  {product.result.pdts.NOM} ·
      ...
      <View style={styles.productFooter}>
        {product.result.PRIX ? (
          <Text style={styles.productPrice}>
            {product.result.PRIX.toString().replace(
              /\B(?=(\d{3})+(?!\d))/g,
              ' ',
            )}{' '}
            Fbu
