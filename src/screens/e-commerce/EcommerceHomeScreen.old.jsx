...
export default function EcommerceHomeScreen() {
          ...
          const onImporterPhoto = async () => {
                    ...
                    try {
                              ...
                              const menuUpdate = await fetchApi(`/service/updateImage/${shop.ID_PARTENAIRE_SERVICE}`, {
                                        method: "PUT",
                                        body: form
                              })
          ...
          var IMAGES = [
                    shop.LOGO ? shop.LOGO : undefined,
                    shop.BACKGROUND_IMAGE ? shop.BACKGROUND_IMAGE : undefined,
          ]
          const [data, handleChange, setValue] = useForm({
                    shop: shop.NOM_ORGANISATION,
                    adresse: shop.ADDRESSE,
                    ouvert: shop.OUVERT,
                    tele: shop.TELEPHONE,
                    description: shop.PRESENTATION,
                    TailleSelect: null,
          ...
          const fecthProduits = async () => {
                    try {
                              const response = await fetchApi(`/products/categorie/${shop.ID_PARTENAIRE_SERVICE} `, {
                                        method: "GET",
          ...
          const UpdateData = async () => {
                    try {
                              ...
                              const updateProduct = await fetchApi(`/partenaire/Updateshop/${shop.ID_PARTENAIRE_SERVICE}`, {
                                        method: "PUT",
                                        body: form
                              })
          ...
          return (
                    <>
                              ...
                              <View style={styles.container}>
                                        <ShopHeader shopName={shop.NOM_ORGANISATION} />
                                        <ScrollView>
                                                  ...
                                                  <View style={styles.shopInfos}>
                                                            ...
                                                            <TouchableOpacity onPress={onPressAdresse}>
                                                                      <View style={{ flexDirection: "row" }}>
                                                                                ...
                                                                                <Text style={{ fontWeight: "bold", ontSize: 12, opacity: 0.5 }}> {updateAdresse ? updateAdresse : shop.ADDRESSE} </Text>
                                                  ...
                                                  <View style={{ flexDirection: "row", marginHorizontal: 10, marginTop: 10, justifyContent: "space-between" }}>
                                                            ...
                                                            <TouchableOpacity onPress={onPressOuvert}>
                                                                      <View style={{ flexDirection: "row", marginHorizontal: 30 }}>
                                                                                ...
                                                                                <Text style={{ fontSize: 15, marginLeft: 2, color: "#797E9A" }}>{updateOuvert ? updateOuvert : shop.OUVERT}</Text>
                                                                                <EvilIcons style={{ opacity: 0.5 }} name="pencil" size={22} color="black" />
                                                            ...
                                                            <TouchableOpacity onPress={() => { Linking.openURL(`tel:${shop.TELEPHONE}`); }} style={{ flexDirection: "row" }}>
                                                                      ...
                                                                      <TouchableOpacity onPress={onPressTele}>
                                                                                <Text style={{ fontSize: 15, marginLeft: 20, color: "#797E9A", right: 15 }}>{updateTele ? updateTele : shop.TELEPHONE}</Text>
                                                                      </TouchableOpacity>
                                                                      {/* <EvilIcons style={{ opacity: 0.5 }} name="pencil" size={22} color="black" /> */}
                                                  ...
                                                  <TouchableOpacity onPress={onPressDescription}>
                                                            <View style={{ marginHorizontal: 10, marginTop: "10%" }} >
                                                                      <Text style={{ color: "#797E9A", fontSize: 11, }}>
                                                                                {updateDescription ? updateDescription : shop.PRESENTATION}
                                                                      </Text>
                                                            </View>
                                                  </TouchableOpacity>
