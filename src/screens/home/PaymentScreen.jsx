...
import EcocashModalize from '../../components/shipping/EcocashModalize';
import EcocashPeddingPayment from '../../components/shipping/EcocashPeddingPayment';

import { useEffect } from 'react';
import Loading from '../../components/app/Loading';
import { useSelector } from 'react-redux';
// import { ecommerceCartSelector } from '../../store/selectors/';
...
export default function PaymentScreen() {
          ...
          const { partenaire ,service} = route.params
                    ...
                    <View style={styles.container}>
                              ...
                              <Portal>
                                        <GestureHandlerRootView style={{ height: isOpen ? '100%' : 0, opacity: isOpen ? 1 : 0, backgroundColor: 'rgba(0, 0, 0, 0)', position: 'absolute', width: '100%', zIndex: 1 }}>
                                                  ...
                                                  >
                                                            <EcocashModalize  info={METHODS[0]} loadingForm={loadingForm} onClose={onCloseModalize}  service={service} partenaire={partenaire} onFInish={onEcocashFinish} />
                                                  </Modalize>
