...
import { Image, Modal, ScrollView, StyleSheet, Text, TouchableNativeFeedback, TouchableOpacity, TouchableWithoutFeedback, useWindowDimensions, View } from 'react-native'
                                                  ...
                                                  return (
                                                            <TouchableWithoutFeedback key={index} onPress={() => {
                                                                      ...
                                                                      <View  style={[styles.imageContainer, { width }]}>
                                                                                ...
                                                                                {false && <TouchableOpacity onPress={() => onImporterPhoto(image, index)} style={styles.uploadImages}>
